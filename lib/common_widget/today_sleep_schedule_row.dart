...
class TodaySleepScheduleRow extends StatefulWidget {
  ...
  @override
  State<TodaySleepScheduleRow> createState() => _UpcomingWorkoutRowState();
}

class _UpcomingWorkoutRowState extends State<TodaySleepScheduleRow> {
  bool positive = false;
  @override
          ...
          Expanded(
            ...
            children: [
              ...
              Text(
                ...
                // "${getDayTitle(widget.sObj["time"].toString())}|${getStringDateToOtherFormate(widget.sObj["time"].toString(), outFormatStr: "h:mm aa")}",
                style: TextStyle(
                    color: TColor.grey,
                    fontSize: 14,
