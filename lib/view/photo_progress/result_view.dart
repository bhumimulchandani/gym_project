...
class _ResultViewState extends State<ResultView> {
  ...
  List imaArr = [
    {
      "title": "Front Facing",
      "month_1_img": "assets/img/pp_1.png",
      "month_2_img": "assets/img/pp_2.png",
    },
    {
      "title": "Back Facing",
      "month_1_img": "assets/img/pp_3.png",
      "month_2_img": "assets/img/pp_4.png",
    },
    {
      "title": "Left Facing",
      "month_1_img": "assets/img/pp_5.png",
      "month_2_img": "assets/img/pp_6.png",
    },
    {
      "title": "Right Facing",
      "month_1_img": "assets/img/pp_7.png",
      "month_2_img": "assets/img/pp_8.png",
    }
  ];
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                    width: 25,
                                    child: Text(iObj["month_1_per"].toString(),
                                  ...
                                  SizedBox(
                                    width: 25,
                                    child: Text(iObj["month_2_per"].toString(),
