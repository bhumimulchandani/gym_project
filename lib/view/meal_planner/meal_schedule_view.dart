...
import 'package:gym_project/common_widget/meal_food_schedule_row.dart';
import 'package:gym_project/common_widget/nutritions_row.dart';
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {},
                            child: Text(
                              "${lunchArr.length} Items | 230 Calories",
                              style: TextStyle(
                                color: TColor.grey,
                                fontSize: 12,
                              ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {},
                            child: Text(
                              "${snackArr.length} Items | 230 Calories",
                              style: TextStyle(
                                color: TColor.grey,
                                fontSize: 12,
                              ),
                  ...
                  ListView.builder(
                      physics: NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: snackArr.length,
                      padding: const EdgeInsets.symmetric(horizontal: 20),
                      itemBuilder: (context, index) {
                        var mObj = snackArr[index] as Map? ?? {};
                        return MealFoodScheduleRow(
                          mObj: mObj,
                          index: index,
                        );
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                            onPressed: () {},
                            child: Text(
                              "${dinnerArr.length} Items | 230 Calories",
                              style: TextStyle(
                                color: TColor.grey,
                                fontSize: 12,
                              ),
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return NutritionsRow(nObj: nObj);
                      }),
                  SizedBox(
                    height: media.width * 0.05,
                  )
